...
using PSKDotNetCore.WinFormsApp.Queries;
...
namespace PSKDotNetCore.WinFormsApp
{
    public partial class FrmBlog : Form
    {
        ...
        public FrmBlog(int blogId)
        {
            ...
            var model = _dapperService.QueryFirstOrDefault<BlogModel>("select BlogId, BlogTitle, BlogAuthor, BlogContent from tbl_blog where BlogId = @BlogId", new { BlogId = _blogId });
