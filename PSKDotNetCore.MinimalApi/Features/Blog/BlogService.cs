...
using PSKDotNetCore.MinimalApi.Db;
using PSKDotNetCore.MinimalApi.Models;

namespace PSKDotNetCore.MinimalApi.Features.Blog;
...
public static class BlogService
{
    public static IEndpointRouteBuilder MapBlogs(this IEndpointRouteBuilder app)
    {
        ...
        app.MapPost("api/Blog", async (AppDbContext db, BlogModel blog) =>
        {
            ...
            string message = result > 0 ? "Save Success." : "Save Failed.";
